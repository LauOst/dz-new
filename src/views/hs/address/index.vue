  ...
  <div class="app-container">
    ...
    <el-dialog v-dialogDrag :close-on-click-modal="false" :title="'编辑'" :visible.sync="dialogVisible" class="dialog" width="530px">
      <el-form ref="formData" :model="formData" :rules="addFormRules" label-width="90px" style=" margin-left:40px;">
        <el-form-item label="MESIP" prop="mesIp">
          <el-input v-model="formData.mesIp" placeholder="请输入IP地址" />
        </el-form-item>
      </el-form>
      <!-- 操作按钮 -->
...
<script>
import { listAddress, updateAddress } from '@/api/hs/address'
  ...
  data() {
    return {
      column: [
        ...
        { label: 'MESIP', prop: 'mesIp', disableSort: true },
