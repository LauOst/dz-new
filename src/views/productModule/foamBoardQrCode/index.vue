    ...
    <el-card shadow="never" class="card">
      <el-form ref="queryForm" :inline="true" :model="queryParams">
        ...
        <el-form-item>
          ...
          <el-button v-hasPermi="['productModule:foamBoardQrCode:excel']" :loading="btnLoading" type="warning" icon="el-icon-download" size="small" @click="handleExport">导出</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    <!-- 表格信息 -->
...
<script>
import { listfoamBoardQrCode } from '@/api/productModule/foamBoardQrCode'
import { downloadfoamBoardQrCode } from '@/api/excel/excel'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listfoamBoardQrCode(this.queryParams).then(res => {
        this.list = res.data
    ...
    handleExport() {
      ...
      downloadfoamBoardQrCode(this.queryParams).then((res) => {
