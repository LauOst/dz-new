<template>
  <div>
    ...
    <el-dialog v-dialogDrag :close-on-click-modal="false" :title="title" :visible.sync="open" width="800px" append-to-body @opened="modalOpened">
      <el-row>
  ...
  methods: {
    ...
    uploadImg() {
      this.$refs.cropper.getCropBlob(data => {
        ...
        imgData.append('picture', data)
        this.$emit('onChangeImg', imgData)
        this.open = false
        this.visible = false
        // uploadAvatar(imgData).then(response => {
        //   this.open = false
