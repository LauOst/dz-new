<template>
  <div class="app-container">
    ...
    <el-card shadow="never" class="card">
      <el-form ref="queryForm" :inline="true" :model="queryParams">
        ...
        <el-form-item prop="equipmentCode">
          <el-input v-model="queryParams.equipmentCode" clearable size="small" placeholder="机器人编号" style="width: 180px;" />
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" size="small" @click="handleQuery">搜索</el-button>
          <el-button icon="el-icon-refresh" size="small" @click="resetQuery">重置</el-button>
          <el-button v-hasPermi="['robot:robotShut:excel']" :loading="btnLoading" type="warning" icon="el-icon-download" size="small" @click="handleExport">导出</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    <!-- 表格信息 -->
    ...
    />
    <!-- 停机详情 -->
    <el-dialog v-dialogDrag :close-on-click-modal="false" :modal-append-to-body="false" title="停机详情" :visible.sync="dialogTableVisible" width="1400px">
...
import { getRobotShut, getRobotShutByNo } from '@/api/robot/robot'
import { downloadRobotShut } from '@/api/excel/excel'
export default {
  name: 'RobotShut',
  data() {
    return {
      column: [
        ...
        { label: '操作', render: (h, scope) => {
          return (
            <div>
              <el-button
                v-hasPermi={['robot:robotShut:detail']}
                type='primary'
                size='mini'
      ...
      columnDetail: [
        ...
        { label: '机器人编号', prop: 'equipmentCode' },
        { label: '机器人名称', prop: 'equipmentName' },
  ...
  methods: {
    ...
    sortChangeDetail(column) {
      this.$mySort(this.queryParamsDetail, column, this.getRobotShutByNoDetail)
    },
    // 获取机器人列表
    getList() {
      this.loading = true
      getRobotShut(this.queryParams).then(res => {
        this.list = res.data
    ...
    handleDetail(id, no) {
      ...
      this.getRobotShutByNoDetail()
    },
    // 获取机器人详情
    getRobotShutByNoDetail() {
      getRobotShutByNo(this.queryParamsDetail).then(res => {
    ...
    handleExport() {
      ...
      downloadRobotShut(this.queryParams).then((res) => {
