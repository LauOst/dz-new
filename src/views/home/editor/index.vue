      ...
      <el-row :gutter="20" style="height: 55%;">
        ...
        <el-col :span="10" style="height: 100%;">
          <chart-card height="100%">
            ...
            <bar-chart :chart-data="monthData" />
          </chart-card>
        </el-col>
      </el-row>
    </div>
...
export default {
  name: 'DashboardAdmin',
  components: { PieChart, ChartCard, PieChartOne, BarChart, Daily },
  data() {
    return {
      queryParams: {},
  ...
  methods: {
    ...
    // 日月生成数据
    handleAndMonthData() {
      geDayAndMonthData(this.queryParams.id).then(res => {
        console.log('??res', res)
    ...
    handleEquipmentState() {
      console.log('this.queryParams', this.queryParams.id)
