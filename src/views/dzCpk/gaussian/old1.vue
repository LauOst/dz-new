    ...
    <div class="top">
      ...
      <div class="top-right l-card">
        <div v-if="detectionrecordList.analysisData && detectionrecordList.analysisData.length > 0" class="right-wrapper">
          ...
          <!--          <div>总样本数：<span class="top-right-text">{{ detectionrecordList.analysisData.length || 0 }}</span></div>-->
          <!--          <div>上限值：<span class="top-right-text">{{ detectionrecordList.upperLimitValue }}</span></div>-->
          <!--          <div>下限值：<span class="top-right-text">{{ detectionrecordList.lowerLimitValue }}</span></div>-->
          <!--          <div>标准值：<span class="top-right-text">{{ detectionrecordList.standValue }}</span></div>-->
          <!--          <div>平均值：<span class="top-right-text">{{ detectionrecordList.cpk.averageValue }}</span></div>-->
          <!--          <div>最大值：<span class="top-right-text">{{ detectionrecordList.cpk.maxValue }}</span></div>-->
          <!--          <div>最小值：<span class="top-right-text">{{ detectionrecordList.cpk.minValue }}</span></div>-->
          <!--          <div>+3sigma：<span class="top-right-text">{{ detectionrecordList.cpk.sigma32 }}</span></div>-->
          <!--          <div>-3sigma：<span class="top-right-text">{{ detectionrecordList.cpk.sigma31 }}</span></div>-->
          <!--          <div>STDEV: <span class="top-right-text">{{ detectionrecordList.cpk.stdev }}</span></div>-->
          <!--          <div>CPK: <span class="top-right-text">{{ detectionrecordList.cpk.cpk }}</span></div>-->
          <!--          <div>CP: <span class="top-right-text">{{ detectionrecordList.cpk.cp }}</span></div>-->
          <!--          <div>CPL: <span class="top-right-text">{{ detectionrecordList.cpk.cpl }}</span></div>-->
          <!--          <div>CPU: <span class="top-right-text">{{ detectionrecordList.cpk.cpu }}</span></div>-->
          <!--          <div>PPM > USL: <span class="top-right-text">{{ detectionrecordList.cpk.ppmgreaterThanUSL }}</span></div>-->
          <!--          <div>PPM Total: <span class="top-right-text">{{ detectionrecordList.cpk.ppmgreaterTotal }}</span></div>-->
          <!--          <div>CA: <span class="top-right-text">{{ detectionrecordList.cpk.ca }}</span></div>-->
          <!--          <div>标准值：<span class="top-right-text">{{ detectionrecordList.standValue }}</span></div>-->
...
import { listGaussian } from '@/api/dzCpk/gaussian'
  ...
  methods: {
    ...
    getList() {
      ...
      listGaussian().then(r => {
        ...
        // this.detectionrecordList.analysisData = r.data.analysisData.slice(0, 100)
        ...
        this.$nextTick(() => {
          if (document.getElementById('myChart1')) {
            ...
            // console.log('myChart1', this.myChart1)
          }
