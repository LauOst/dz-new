  ...
  install: function(Vue) {
    Vue.directive('defaultSelect', {
      componentUpdated(el, bindings, vnode) {
        ...
        const values = bindings.value[0]
        const options = bindings.value[1]
        const prop = bindings.value[2]
        const defaultProp = bindings.value[3]
        const defaultValue = bindings.value[4]
        // const options = bindings.value[1]
